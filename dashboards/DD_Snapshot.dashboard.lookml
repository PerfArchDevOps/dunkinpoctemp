- dashboard: dd_sales_snapshot
  ...
  - name: QTD
    ...
    limit_displayed_rows: false
    enable_conditional_formatting: false
    header_background_color: "#0affff"
    header_text_alignment: left
    header_font_size: '10'
    rows_font_size: '8'
    conditional_formatting: [{type: along a scale..., value: !!null '', background_color: "#F184B9",
        font_color: !!null '', color_application: {collection_id: dunkin, palette_id: dunkin-diverging-0,
    ...
    dynamic_fields: [{table_calculation: sales, label: Sales, expression: "${pos_brand_by_week_dayprt_grp_f.net_sales_amt}\
          \ / ${pos_yoy_week_sales_f.site_count_sssd}", value_format: !!null '', value_format_name: decimal_1,
  ...
  - name: QTD (2)
    ...
    dynamic_fields: [{table_calculation: sales, label: Sales, expression: "${pos_brand_by_week_dayprt_grp_f.net_sales_amt}\
          \ / ${pos_yoy_week_sales_f.site_count_sssd}", value_format: !!null '', value_format_name: decimal_2,
        _kind_hint: measure, _type_hint: number}]
    row: 6
    col: 16
    width: 4
  ...
  - name: DD Ops Vice President
    ...
    limit_displayed_rows: false
    enable_conditional_formatting: false
    header_background_color: "#FCA973"
    header_text_alignment: left
    header_font_size: '10'
    rows_font_size: '8'
    conditional_formatting: [{type: along a scale..., value: !!null '', background_color: "#F184B9",
    ...
    dynamic_fields: [{table_calculation: sales, label: Sales, expression: "${pos_brand_by_week_dayprt_grp_f.net_sales_amt}\
        ...
        table_calculation: tkt_avg_ly, label: Tkt Avg LY, expression: "${pos_brand_by_week_dayprt_grp_f.net_sales_amt_ly}\
  ...
  - name: MTD
    ...
    limit_displayed_rows: false
    enable_conditional_formatting: false
    header_background_color: "#fdff83"
    header_text_alignment: left
    header_font_size: '10'
    rows_font_size: '8'
    conditional_formatting: [{type: along a scale..., value: !!null '', background_color: "#F184B9",
